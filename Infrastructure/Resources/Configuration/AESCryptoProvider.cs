...
namespace Infrastructure.Resources.Configuration
{
    public static class AESCryptoProvider
    {
        ...
        private static readonly byte[] Key = Convert.FromBase64String(ResourceContainer.Configuration.ReadValue("encryption", "key"));
        private static readonly byte[] Vector = Convert.FromBase64String(ResourceContainer.Configuration.ReadValue("encryption", "vector"));
