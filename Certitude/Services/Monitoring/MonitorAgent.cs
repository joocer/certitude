...
{
    class MonitorAgent : IMonitorService
    {
        ...
        public void IncrementCounter(string counter)
        {
            ...
            {
                _category = ServiceFactory.ConfigurationService.ReadValue("diagnostics", "performance-counters-category");
                _enabled = (ServiceFactory.ConfigurationService.ReadValue("diagnostics", "performance-counters-enabled").ToLower() == "true");
            }
